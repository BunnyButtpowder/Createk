    ...
    <section class="bg-brand-dark pb-20">
      <div class="container-custom">
        <div class="max-w-4xl mx-auto prose-policy reveal">
          ...
          <p class="text-brand-gray-light text-sm leading-relaxed mb-6">${t('terms.changes.p1')}</p>

          <h3 class="font-heading text-lg uppercase tracking-wider text-white mt-10 mb-4">${t('terms.trademarks.title')}</h3>
          <p class="text-brand-gray-light text-sm leading-relaxed mb-6">${t('terms.trademarks.p1')}</p>

          <h3 class="font-heading text-lg uppercase tracking-wider text-white mt-10 mb-4">${t('terms.copyright.title')}</h3>
          <p class="text-brand-gray-light text-sm leading-relaxed mb-4">${t('terms.copyright.p1')}</p>
          <ol class="list-decimal list-inside text-brand-gray-light text-sm leading-relaxed mb-4 space-y-1 ml-2">
            ${t('terms.copyright.conditions').map(item => `<li>${item}</li>`).join('')}
          </ol>
          <p class="text-brand-gray-light text-sm leading-relaxed mb-3">${t('terms.copyright.p2')}</p>
          ...
          <p class="text-brand-gray-light text-sm leading-relaxed mb-6">${t('terms.thirdPartyLinks.p1')}</p>

          <h3 class="font-heading text-lg uppercase tracking-wider text-white mt-10 mb-4">${t('terms.conduct.title')}</h3>
          <p class="text-brand-gray-light text-sm leading-relaxed mb-3">${t('terms.conduct.p1')}</p>
          <ul class="list-disc list-inside text-brand-gray-light text-sm leading-relaxed mb-6 space-y-1 ml-2">
          ...
          <p class="text-brand-gray-light text-sm leading-relaxed mb-6">${t('terms.globalAvailability.p1')}</p>

          <h3 class="font-heading text-lg uppercase tracking-wider text-white mt-10 mb-4">${t('terms.disclaimer.title')}</h3>
          <p class="text-brand-gray-light text-sm leading-relaxed mb-6">${t('terms.disclaimer.p1')}</p>

          <h3 class="font-heading text-lg uppercase tracking-wider text-white mt-10 mb-4">${t('terms.liability.title')}</h3>
          <p class="text-brand-gray-light text-sm leading-relaxed mb-6">${t('terms.liability.p1')}</p>

          <h3 class="font-heading text-lg uppercase tracking-wider text-white mt-10 mb-4">${t('terms.jurisdiction.title')}</h3>
          <p class="text-brand-gray-light text-sm leading-relaxed mb-6">${t('terms.jurisdiction.p1')}</p>

          <h3 class="font-heading text-lg uppercase tracking-wider text-white mt-10 mb-4">${t('terms.contactUs.title')}</h3>
          <p class="text-brand-gray-light text-sm leading-relaxed mb-3">${t('terms.contactUs.p1')}</p>
