    ...
    <section class="bg-brand-dark py-5 md:py-20">
      <div class="container-custom">
        <div class="max-w-4xl mx-auto prose-policy reveal" id="privacy-content">
          ...
          <p class="text-brand-gray-light text-base leading-relaxed mb-4">${t('privacy.personalInfo.p1')}</p>
          <p class="text-brand-gray-light text-base leading-relaxed mb-3">${t('privacy.personalInfo.p2')}</p>
          ...
          <p class="text-brand-gray-light text-base leading-relaxed mb-6">${t('privacy.otherInfo.p1')}</p>

          <h3 class="font-heading text-lg uppercase tracking-wider text-white mt-10 mb-4">${t('privacy.thirdPartyLinks.title')}</h3>
          <p class="text-brand-gray-light text-base leading-relaxed mb-6">${t('privacy.thirdPartyLinks.p1')}</p>

          <h3 class="font-heading text-lg uppercase tracking-wider text-white mt-10 mb-4">${t('privacy.children.title')}</h3>
          <p class="text-brand-gray-light text-base leading-relaxed mb-6">${t('privacy.children.p1')}</p>

          <h3 class="font-heading text-lg uppercase tracking-wider text-white mt-10 mb-4">${t('privacy.changes.title')}</h3>
          <p class="text-brand-gray-light text-base leading-relaxed mb-6">${t('privacy.changes.p1')}</p>

          <h3 class="font-heading text-lg uppercase tracking-wider text-white mt-10 mb-4">${t('privacy.contactUs.title')}</h3>
          <p class="text-brand-gray-light text-base leading-relaxed mb-3">${t('privacy.contactUs.p1')}</p>
