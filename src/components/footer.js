          ...
          <div>
            ...
            <ul class="space-y-4">
              ...
              <li class="flex items-start gap-3">
                ...
                <span class="text-brand-gray-light text-base">${t('contact.anThai.address')}</span>
              </li>
              <li class="flex items-center gap-3">
                ...
                <span class="text-brand-gray-light text-base">${t('contact.anThai.phone')}</span>
              </li>
              <li class="flex items-center gap-3">
                <svg class="w-5 h-5 text-brand-gold shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                </svg>
                <a href="mailto:marketing@anthaiautoparts.com" class="text-brand-gray-light text-base hover:text-brand-gold transition-colors duration-300">marketing@anthaiautoparts.com</a>
              </li>
