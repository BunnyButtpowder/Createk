        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 sm:gap-12 lg:gap-16">
          ...
          <div>
            ...
            <li class="flex items-start gap-3">
                <span class="text-brand-gray-light text-sm font-semibold">${t('contact.anThai.title')}</span>
              </li>
              <li class="flex items-start gap-3">
                ...
                <span class="text-brand-gray-light text-sm">${t('contact.anThai.address')}</span>
              </li>
              <li class="flex items-center gap-3">
                ...
                <span class="text-brand-gray-light text-sm">${t('contact.anThai.phone')}</span>
              </li>
